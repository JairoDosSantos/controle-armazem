...
export function GuiaTransporte({ auditoria }: AuditoriaProps) {
    const data = moment().format("DD/MM/yyyy")
    const ano = (new Date()).getFullYear()
    return (


        <Document title="Guia de Transporte - GT">
