    ...
    return (
        <div className='flex'>
            ...
            <main className='flex-1 space-y-6'>
                ...
                <Head>
                    <title>SCA | Devoluções ao Armazem geral</title>
                </Head>
                ...
                <div className='overflow-auto max-h-[85vh] max-w-6xl mx-auto overflow-hide-scroll-bar'>
                    ...
                    <div className='mt-8 text-end px-4 py-2 max-w-6xl  mx-auto bg-white rounded'>
                        <span className='font-semibold text-lg'>Relatório de devolução</span>
                        <table className='table w-full text-center mt-2 animate__animated animate__fadeIn'>
                            <thead>
                                <tr className='flex justify-between bg-gray-200 px-4 py-2 rounded'>
                                    ...
                                    <th className='text-gray-600 font-bold w-1/5'>Qtd. levada</th>
                                    <th className='text-gray-600 font-bold w-1/5'>Qtd. devolvida</th>
                                    <th className='text-gray-600 font-bold w-1/5'>Data devolução</th>
                                    <th className='text-gray-600 font-bold w-1/5'>Data de aquisição</th>
                            ...
                            <tbody className=''>
                                <tr className='flex justify-between border shadow-md mt-4 px-4 py-2'>
                                    ...
                                    <td className="w-1/5 ">20</td>
                                    <td className="w-1/5 ">10</td>
